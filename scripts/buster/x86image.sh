...
cp volumio/buster/bin/volumio_hda_intel_tweak.sh /mnt/volumio/rootfs/usr/local/bin/volumio_hda_intel_tweak.sh
chmod +x /mnt/volumio/rootfs/usr/local/bin/volumio_hda_intel_tweak.sh

cp volumio/buster/splash/volumio.png /mnt/volumio/rootfs/boot
...
cp volumio/buster/etc/ata-modules.x86 /mnt/volumio/rootfs/ata-modules.x86
