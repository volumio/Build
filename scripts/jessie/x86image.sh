...
cp scripts/jessie/x86config.sh /mnt/volumio/rootfs
...
cp volumio/jessie/splash/volumio.png /mnt/volumio/rootfs/boot

cp scripts/jessie/initramfs/init-x86 /mnt/volumio/rootfs/root/init
cp scripts/jessie/initramfs/mkinitramfs-custom.sh /mnt/volumio/rootfs/usr/local/sbin

cp volumio/jessie/etc/ata-modules.x86 /mnt/volumio/rootfs/ata-modules.x86
